...
const MATCHING_CONTRACT = { runtime: '0.1.0-rc.6', api: '0.1' }
const MATCHING_MANIFEST = { version: '0.1.0-rc.6-0.1.0', api: '0.1' }
...
test('the public catalog accessor filters replacement slices by guard while subscriptions use static metadata', () => {
  ...
  const listener = () => {}
  const handle = bus.observe('compaction/request').handle
