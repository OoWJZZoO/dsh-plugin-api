...
test('subtraction: renamed/merged/split/migrated old paths are absent while their targets exist', () => {
  ...
  const removed = [
    ...
    'sessions.channels.onChange', 'sessions.channels.subscribe', 'sessions.channels.list',
  ...
  const present = {
    ...
    'sessions.channels.release': 'function', 'sessions.channels.history': 'function',
    'sessions.channels.current': 'function', 'sessions.channels.observe': 'function',
    'sessions.channels.subscriptions.acquire': 'function',
