...
assert.equal(features.length, 28)
  ...
  assert.equal(features[21].name, 'workspaceTransactions')
  assert.equal(features[21].isActive, true)
  assert.equal(features[22].name, 'diagnostics')
  ...
  assert.equal(features[25].name, 'skillsActivation')
  assert.equal(features[26].name, 'context')
  assert.equal(features[27].name, 'profile')
  assert.equal(features[27].isActive, true)
