...
test('capabilities surface is frozen and lists registry-backed capability paths', () => {
  ...
  assert.deepEqual(capabilities.list({ prefix: 'sessions.' }), ['sessions.branches', 'sessions.channels', 'sessions.activity', 'sessions.planMode', 'sessions.request', 'sessions.cancel'])
})
