...
export const HOST_EVENT_CONTRACTS = freeze([
  {
    ...
    args: '(payload)',
    producer: Object.freeze({ kind: 'official', authority: 'agent-loop', owners: Object.freeze([]) }),
    fault: 'contain',
    freeze: 'all',
  },
  {
    ...
    producer: Object.freeze({ kind: 'official', authority: 'agent-preset', owners: Object.freeze([]) }),
    fault: 'contain',
    freeze: 'all',
  },
  {
    ...
    args: '(pkg)',
    producer: Object.freeze({ kind: 'official', authority: 'cordis', owners: Object.freeze([]) }),
    fault: 'contain',
    freeze: 'all',
  },
  {
  ...
  },
  {
    ...
    args: '(change)',
    producer: Object.freeze({ kind: 'official', authority: 'domain', owners: Object.freeze([]) }),
    fault: 'contain',
    freeze: 'all',
  },
])
