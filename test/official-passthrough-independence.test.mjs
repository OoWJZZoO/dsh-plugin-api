...
const BRANCH_ADDED_FEATURES = ['security', 'execution', 'recovery', 'coordination', 'workspaceTransactions', 'tasks', 'diagnostics', 'toolDiscovery', 'skillsActivation', 'sessionBranch', 'context', 'profile', 'sessionChannel']
