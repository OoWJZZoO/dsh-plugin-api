...
const BRANCH_ADDED_FEATURES = ['security', 'execution', 'recovery', 'coordination', 'storage', 'workspaceTransactions', 'tasks', 'diagnostics', 'toolDiscovery', 'skillsActivation', 'sessionBranch', 'context', 'profile', 'llmAdapters', 'sessionChannel', 'sessionActivity', 'sessionPlanMode', 'sessionInteraction', 'attention', 'checkpoints', 'decisionParticipation',
      'scopedAgentContributions']
