...
test('apply mounts the remote feature as the last entry and exposes pluginApi.remote', () => {
  ...
  assert.equal(names[names.length - 2], 'remote', 'remote stays directly before execution')
  assert.equal(names[names.length - 1], 'execution', 'execution is the last FEATURE_MOUNTERS entry')
