...
function createHarness(options = {}) {
  ...
  assert.equal(streamListeners.length, 4, 'the request owner installs exactly one raw llm/stream listener beside the execution observation listener, the usage intake observer, and the security facade listener')
