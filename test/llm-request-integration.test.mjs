...
function createHarness(options = {}) {
  ...
  assert.equal(streamListeners.length, 3, 'the request owner installs exactly one raw llm/stream listener beside the execution observation listener and the security facade listener')
