...
| `plugin-api-m3-integration` | M3 final integration and migration boundary | delivered | `docs/specs/plugin-api-m3-integration/` | W5 composition, client bundle loader verification, consumer migrations, full test/diff-check and official-package audit complete；C7/ST7 remain proposals。 |
