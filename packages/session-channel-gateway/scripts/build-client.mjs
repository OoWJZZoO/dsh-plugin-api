/**
 * Build the gateway replacement bundle's client half (`lib/client.js`).
 *
 ...
 *   1. reads the official `@deepseek-ai/dsh-api-gateway` browser bundle
 ...
 *      exports with the incremental browser slice
...
const officialClientPath = require.resolve('@deepseek-ai/dsh-api-gateway/client')
