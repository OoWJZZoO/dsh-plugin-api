/**
 * Vendored fork of the official `@deepseek-ai/dsh-api-remotes` host half
 * (`lib/index.js`, version 0.1.0-rc.6), MIT licensed.
 *
 * Source: /usr/lib/node_modules/@deepseek-ai/dsh/node_modules/@deepseek-ai/dsh-api-remotes/lib/index.js
 * Forked verbatim; semantic changes are marked with `// replacement patch:` lines.
 * The official import surface is never covered: third-party
 * `import "@deepseek-ai/dsh-api-remotes"` still resolves the official package.
 */
