 ...
 * is `<runtime full version>-<api protocol major.minor>`; direction one pins
 * the runtime and the replaced owner package identity, direction two compares
 * the main facade's negotiated API protocol (AGENTS.md §4 decision 2).
 */
...
export const LOCKED_OWNER_PACKAGE = '@deepseek-ai/dsh-api-remotes'
...
/**
 * Whether an installed package identity exactly equals the locked runtime.
