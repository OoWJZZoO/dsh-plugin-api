 ...
 *
 * Pure functions (zero harness dependencies). Same contract as the
 * api-remotes slice: the full unique package version is
 * `<runtime full version>-<api protocol major.minor>`.
 */
...
export const LOCKED_OWNER_PACKAGE = '@deepseek-ai/dsh-client-runtime'
