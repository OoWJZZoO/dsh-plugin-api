 ...
 *
 * Pure functions (zero harness dependencies). Direction ① pins the runtime
 * and the replaced owner package identity; direction ② compares the main
 * facade's negotiated API protocol.
 */
...
export const LOCKED_OWNER_PACKAGE = '@deepseek-ai/dsh-workspace'
...
/**
 * Whether an installed package identity exactly equals the locked value.
