 ...
 *
 * Pure functions, zero harness dependencies. Local copy kept in sync with the
 * main facade's `lib/session-channel-shared.js`; a consistency test asserts
 * the copies are 1:1 identical. The replacement package does not import the
 * main package's runtime.
 *
 * @module
 */
