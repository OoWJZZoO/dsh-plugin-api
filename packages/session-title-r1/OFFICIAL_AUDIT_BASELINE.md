...
> Part of `plugin-api-session-title-r1` Stage 4 task 1.4 (requirements 2.3 / 8.3).
> The R-class replacement bundle `@deepseek-ai/dsh-plugin-api-session-title` forks
