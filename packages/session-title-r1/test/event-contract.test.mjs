...
test('a thenable return is malformed with a thenable flag (requirements 5.8)', () => {
...
test('buildSessionTitleCandidatePayload deep-freezes message+source but keeps agent/session live (req 5.11)', () => {
