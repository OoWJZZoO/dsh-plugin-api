 ...
 * R-class replacement bundle. Zero harness dependencies: no Cordis, no DSH
 ...
 *   (requirements 5.11 as revised in Stage 2);
 * - replacement-reference resolution against the session log
 *   (requirements 5.6, design Data Models);
 ...
 * thenable and a rejection handler was attached (requirements 5.8).
 *
 * @param {unknown} value
 ...
 * (requirements 5.11, design C4). The payload object itself is also frozen.
 *
 ...
 * candidate and logs one redacted diagnostic (requirements 5.6).
 *
