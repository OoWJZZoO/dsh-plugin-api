 ...
 * registry service, permission system or package identity. The egress face is
 * a denylist, so a missing contract means no deny policy can be consulted:
 * the consuming component keeps the official outbound behavior (allow) and
 * reports the affected path unavailable.
 */
