 ...
 * plugin-api-m1-integration KD-2):
 *
 * - `'all'` (and the missing-policy default) reproduces the original E9
 ...
 * @param {'all' | 'except-signal' | { deep: string[] }} [policy] - catalog freeze policy
...
export function freezeByPolicy(value, policy) {
  ...
  // 'all' or absent policy: default to the E9 deep-freeze.
