    ...
    constructor(ctx, config) {
      ...
      Object.defineProperty(this, 'executions', {
        ...
        get() {
          ...
          // the engines keep their own records. The recovery plane is left as
          // it is: its ownerId/generation identify the operation under recovery
          // (a declared resource scope the evaluate call matches on), not the
          // plugin that registers the capability.
          const bound = bindExecutionVisibility(executions, callerCtx, () => ++registrationSequence)
