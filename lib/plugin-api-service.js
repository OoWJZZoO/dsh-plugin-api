      ...
      if (name === 'toolDiscovery') {
        ...
        const surface = Object.freeze({
          ...
          list: (...args) => {
            ...
            if (typeof fn !== 'function') throw new PluginApiFeatureDisabledError('toolDiscovery', 'discovery search owner is unavailable')
            return Reflect.apply(fn, api, args)
          },
          ...
          audit: Object.freeze({
            list: (...args) => {
              ...
              if (typeof fn !== 'function') throw new PluginApiFeatureDisabledError('toolDiscovery', 'discovery audit owner is unavailable')
