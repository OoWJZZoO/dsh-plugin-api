  ...
  return class PluginApiService extends Service {
    ...
    constructor(ctx, config) {
      ...
      Object.defineProperty(this, 'sessions', {
        ...
        get() {
          const decorated = this._decoratedNamespaces(['sessions', 'sessions.branches', 'sessions.channels', 'sessions.views', 'sessions.activity', 'sessions.compaction'], this._sessionSurface)
