  ...
  return class PluginApiService extends Service {
    ...
    _assignFeature(name, api) {
      ...
      if (name === 'toolDiscovery') {
        ...
        // caller binding is forwarded as the trailing argument; the surrounding
        // read and lifecycle members keep their exact argument lists.
        const invokeNested = (parent, method, { callerBound = false } = {}) => (...args) => {
          fail()
          const forwarded = callerBound ? [...args, this?.ctx ?? this] : args
