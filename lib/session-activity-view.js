 ...
 */
export function createSessionActivityView({ store } = {}) {
  ...
  function list(options = {}) {
    ...
    if (!isNonEmptyString(opts.sessionId)) return deepFreeze({ items: [], nextCursor: undefined, truncated: false, gap: null })
