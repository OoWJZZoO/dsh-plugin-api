/**
 * pluginApi.settings — stabilized settings namespace facade (plugin-api-settings-m1).
 *
 * A-class passthrough over the official `ctx.settings` service:
 ...
 * time, `register`/`scope`/`describe` throw `PluginApiServiceUnavailableError`.
 */
