...
/**
 * Execution source adapter: consumes the public `pluginApi.execution`
...
/**
 * Recovery source adapter: consumes `pluginApi.recovery` decisions and
 ...
 * `pluginApi.workspaceTransactions` get/observe projection when the same-batch
