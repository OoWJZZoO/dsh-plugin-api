...
/** Per-component capture status vocabulary (requirements §2). */
...
/** Restoreability vocabulary (requirements §5). */
...
/** External effect rollbackability vocabulary (requirements §10). */
