...
export const CAPABILITY_MATRIX = Object.freeze([
  ...
  entry({"capabilityCluster": "llm.adapters", "status": "retained", "qualifiers": ["split"], "replacement": "real adapter route registration binds the official registerAdapter action; decorations move to llm.adapters.decorations.register/list with their own registry identity (no alias)", "gapReason": null}),
  ...
  entry({"capabilityCluster": "agents.scopes", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "agents.decisions", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  ...
  entry({"capabilityCluster": "security.egress removals", "status": "deleted", "qualifiers": [], "replacement": "security.egress.check -> automatic evaluation (denylist): registered egress policies are evaluated by the internal egress authority before any outbound side effect on the supported official paths (llm model discovery, mcp stdio/http transport); an empty registry keeps the official outbound behavior and only an explicit deny blocks; cooperative callers register policies and acquire/release typed leases", "gapReason": null}),
  ...
  entry({"capabilityCluster": "services.appExit", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  ...
  entry({"capabilityCluster": "sessions.activity", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.planMode", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.permissionPresets", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "credentials", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.compaction", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.interactions", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.selection", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "workflows", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.activity.attempt-facts", "status": "retained", "qualifiers": ["split"], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.request", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "sessions.cancel", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "attention", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "executions.recovery.checkpoints", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "executions.recovery.checkpoints.capture.branch", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "executions.recovery.checkpoints.capture.workspace-journal", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "executions.recovery.checkpoints.capture.workspace-snapshot", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "executions.recovery.checkpoints.restore", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "executions.recovery.checkpoints.restore.stop-then-restore", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "client.sessions", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
  entry({"capabilityCluster": "client.attention", "status": "retained", "qualifiers": [], "replacement": null, "gapReason": null}),
])
