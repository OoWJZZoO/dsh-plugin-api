...
export const CAPABILITY_MATRIX = Object.freeze([
  ...
  entry({"capabilityCluster": "llm.routing.health removals", "status": "deleted", "qualifiers": [], "replacement": "llm.routing.health.probe -> llm.routing.health.probe.register plus automatic probe execution with llm.routing.health.observe; llm.routing.health.startProbe -> llm.routing.health.probe.register plus automatic probe execution with llm.routing.health.observe; llm.routing.health.completeProbe -> llm.routing.health.probe.register plus automatic probe execution with llm.routing.health.observe", "gapReason": null}),
  ...
  entry({"capabilityCluster": "executions.recovery removals", "status": "deleted", "qualifiers": [], "replacement": "executions.recovery.visibility.project -> automatic recovery projection driven by the recovery owner", "gapReason": "executions.recovery.consume: consultation-style acknowledgement; conservation requires automatic consumption evidence, otherwise a gap until that evidence exists"}),
  ...
  entry({"capabilityCluster": "security.egress removals", "status": "deleted", "qualifiers": [], "replacement": null, "gapReason": "security.egress.check: consultation-style check; the policy applies automatically at the decision point, gap until automatic application is proven"}),
  ...
  entry({"capabilityCluster": "storage removals", "status": "deleted", "qualifiers": [], "replacement": null, "gapReason": "storage.open.handle.close: close is not a valid handle destruction verb; the operation handle dispose() covers destruction"}),
  ...
  entry({"capabilityCluster": "events.define", "status": "gap", "qualifiers": [], "replacement": null, "gapReason": "the runtime cannot enforce owner scope for custom event dispatch; requires an upstream owner-scoped publisher seam (unavailable/proposal capability)"})
])
