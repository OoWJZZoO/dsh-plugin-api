...
const SERVICES_REGISTRY_METADATA = Object.freeze({
  ...
  workflows: Object.freeze({ composition: 'pure', authority: 'official workflow passthrough; facade forwards 1:1', availability: 'official workflowEngine service present -> active; absent -> typed unavailable', visibility: 'official low-level service' }),
  ...
  compaction: Object.freeze({ composition: 'pure', authority: 'official compaction passthrough; facade forwards 1:1', availability: 'official compaction service present -> active; absent -> typed unavailable', visibility: 'official low-level service' }),
