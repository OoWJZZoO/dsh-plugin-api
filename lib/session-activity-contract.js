...
function validAttemptStart(payload) {
  ...
  if (payload.operationId !== undefined && !isNonEmptyString(payload.operationId)) return false
  if (payload.executionId !== undefined && !isNonEmptyString(payload.executionId)) return false
  return true
}
...
function validAttemptEnd(payload) {
  ...
  if (payload.classification !== undefined && typeof payload.classification !== 'string') return false
  return true
}
