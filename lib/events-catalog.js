 ...
 * shape, source feature id, and A/B provenance. The base version covers
 ...
 * plugin-api-system-prompt-m1 extends the catalog with 2 system-prompt events
 * (21 event names total).
 *
 ...
 *   subject: 'args[0].agent' | 'args[1].scope' | null | undefined,
 *   payload: string,
 *   args: string,
 *   source: string,
 *   type: 'A' | 'B',
