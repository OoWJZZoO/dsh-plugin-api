 ...
 * @returns {Readonly<{ platform: string, inject?: readonly string[], immediately?: boolean }>}
 */
...
export function isManifest(value) {
  if (!isRecord(value) || typeof value.platform !== 'string' || value.platform.length === 0) return false
