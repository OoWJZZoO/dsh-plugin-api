...
const FEATURE_MOUNTERS = new Map([
  ...
  // context-provenance
  // The sibling skill feature's entry lands directly above this one at
  // integration time (this line only appends after toolDiscovery and never
  // reorders existing branches).
