/**
 * C8 host leaf: a typed, read-only forwarding face for the official Typert
...
export const TYPERT = Object.freeze({
  package: '@deepseek-ai/dsh-plugin-api',
  face: 'host',
...
/**
 * Create the active C8 facade from the official service in `ctx`.
 *
...
/**
 * Build the standard disabled C8 face. The shape remains visible so callers
