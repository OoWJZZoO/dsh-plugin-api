...
- [ ] **1.1 创建 integration 分支并合并 m1/tools**
...
- [ ] **2.3 两遍式 apply + 挂载期 slice 组合 + guard 归并**
...
- [ ] **2.7 tools accessor fail-safe + mountFeature 契约**
...
- [ ] **2.8 session.on passthrough 语义固化**
