...
| events.emit | host | operation | execute | exclusive | facade | event producer authority | not-applicable | exclusive | namespace availability() | returns undefined |
| events.serial | host | operation | execute | exclusive | facade | event producer authority | not-applicable | exclusive | namespace availability() | returns undefined |
| events.parallel | host | operation | execute | exclusive | facade | event producer authority | not-applicable | exclusive | namespace availability() | returns undefined |
| events.bail | host | operation | execute | exclusive | facade | event producer authority | not-applicable | exclusive | namespace availability() | returns undefined |
| events.waterfall | host | operation | execute | exclusive | facade | event producer authority | not-applicable | exclusive | namespace availability() | returns undefined |
...
| llm.requestTransforms.register.handle | host | policy | decide | ordered | facade | llm domain authority | owner-conflict | latest-wins | namespace availability() | bare disposer |
| llm.admissionPolicies.register | host | policy | decide | ordered | facade | llm domain authority | owner-conflict | latest-wins | namespace availability() | policy registration |
| llm.admissionPolicies.register.handle | host | policy | decide | ordered | facade | llm domain authority | owner-conflict | latest-wins | namespace availability() | bare disposer |
...
| llm.routing.policies.register | host | policy | decide | ordered | facade | llm domain authority | owner-conflict | latest-wins | namespace availability() | route policy registration (plural leaf) |
| llm.routing.candidates.register | host | resourceRegistry | register | additive | facade | llm domain authority | content-conflict | latest-wins | namespace availability() | candidate registration |
...
| agents.providers.register.handle | host | resourceRegistry | register | additive | facade | agent registry authority | content-conflict | latest-wins | namespace availability() | provider claim handles |
...
| executions.get | host | projection | read | pure | facade | execution authority | not-applicable | — | namespace availability() | execution view query |
...
| tools.register | host | resourceRegistry | register | additive | facade | tools authority | content-conflict | latest-wins | namespace availability() | tool definition registration; optional opts.scope installs the definition through the target agent context (scoped layer, target-only visibility) with (owner, scope, key) conflict keys — a second scoped registration under the same key is a typed conflict before the official backing is reached (no content comparison), while the global path keeps the official content-idempotent/content-conflict semantics |
| tools.register.handle | host | resourceRegistry | register | additive | facade | tools authority | content-conflict | latest-wins | namespace availability() | registration result |
...
| tools.discovery.catalog.register | host | resourceRegistry | register | additive | facade | tools authority | content-conflict | latest-wins | namespace availability() | catalog entry registration |
...
| tools.discovery.catalog.register.handle | host | resourceRegistry | register | additive | facade | tools authority | content-conflict | latest-wins | namespace availability() | catalog registration result |
...
| prompts.provenance.policy.register | host | policy | decide | ordered | facade | system prompt authority | owner-conflict | latest-wins | namespace availability() | provenance policy registration |
...
| attachments.pipeline.transforms.register.handle | host | resourceRegistry | register | additive | facade | attachment pipeline authority | content-conflict | latest-wins | namespace availability() | transform registration result |
...
| tasks.get | host | projection | read | pure | facade | task authority | not-applicable | — | namespace availability() | task query |
...
| tasks.history | host | projection | read | pure | facade | task authority | not-applicable | — | namespace availability() | task history query |
...
| diagnostics.register | host | resourceRegistry | register | additive | facade | diagnostics authority | content-conflict | latest-wins | namespace availability() | diagnostics source registration |
...
| remotes.register.handle | host | resourceRegistry | register | additive | facade | remote publication authority | content-conflict | latest-wins | namespace availability() | publication disposer |
...
| llm.routing.policies.register.handle | host | policy | decide | ordered | facade | llm domain authority | owner-conflict | latest-wins | namespace availability() | — |
| llm.routing.candidates.register.handle | host | resourceRegistry | register | additive | facade | llm domain authority | content-conflict | latest-wins | namespace availability() | — |
| llm.routing.health.circuitPolicy.register.handle | host | policy | decide | ordered | facade | llm domain authority | owner-conflict | latest-wins | namespace availability() | — |
| llm.routing.health.probe.register.handle | host | resourceRegistry | register | additive | facade | llm domain authority | content-conflict | latest-wins | namespace availability() | — |
...
| tools.restrict.register.handle | host | policy | decide | ordered | facade | tools authority | owner-conflict | latest-wins | namespace availability() | — |
| tools.guard.register.handle | host | policy | decide | ordered | facade | tools authority | owner-conflict | latest-wins | namespace availability() | — |
| tools.presentation.register.handle | host | resourceRegistry | register | additive | facade | tools authority | content-conflict | latest-wins | namespace availability() | — |
...
| prompts.provenance.policy.register.handle | host | policy | decide | ordered | facade | system prompt authority | owner-conflict | latest-wins | namespace availability() | — |
...
| diagnostics.register.handle | host | resourceRegistry | register | additive | facade | diagnostics authority | content-conflict | latest-wins | namespace availability() | — |
...
| llm.requestTransforms.register | host | policy | decide | ordered | facade | llm authority | owner-conflict | latest-wins | namespace availability() | official transform registration disposer |
| llm.routing.health.circuitPolicy.register | host | policy | decide | ordered | facade | routing authority | owner-conflict | latest-wins | namespace availability() | route policy replacement registration |
| llm.routing.health.probe.register | host | resourceRegistry | register | additive | facade | routing authority | content-conflict | latest-wins | namespace availability() | route policy replacement registration |
| agents.providers.register | host | resourceRegistry | register | additive | facade | agents authority | content-conflict | latest-wins | namespace availability() | merged provider claim registration |
...
| tools.restrict.register | host | policy | decide | ordered | facade | tools authority | owner-conflict | latest-wins | namespace availability() | official restriction registration disposer; optional opts.scope installs the restriction through the target agent context (official restrict requires a scoped context) |
| tools.guard.register | host | policy | decide | ordered | facade | tools authority | owner-conflict | latest-wins | namespace availability() | official guard registration disposer |
| tools.presentation.register | host | resourceRegistry | register | additive | facade | tools authority | content-conflict | latest-wins | namespace availability() | official presentation registration disposer |
...
| attachments.pipeline.transforms.register | host | resourceRegistry | register | additive | facade | attachments authority | content-conflict | latest-wins | namespace availability() | official transform registration disposer |
...
| workflows.start | host | operation | execute | additive | profile | workflow authority | not-applicable | — | namespace availability member on workflows | frozen synchronous discriminated result: started with the run handle, or a no-run refusal (official codes passed through unchanged; facade codes invalid-request / parent-unresolved / internal) |
| workflows.start.handle | host | operation | execute | additive | profile | workflow authority | not-applicable | — | none | handle { id, ownerId, meta, status(), observe(listener), result, cancel(reason?), dispose() } (idiom exceptions recorded); observe is a run-scoped filter over the existing workflow/* feed |
...
| executions.recovery.checkpoints.restore | host | operation | execute | coordinated | session | checkpoint restore authority (single operation terminal) | fencing | exclusive | namespace availability() | typed {ok:true, code:accepted\|completed, handle:{id, status(), observe(), dispose()}} \| {ok:false, code:denied\|conflict\|unavailable\|stale} |
| executions.recovery.checkpoints.restore.handle | host | operation | read | coordinated | session | checkpoint restore authority | fencing | exclusive | none | members: id / ownerId / status() / observe() / dispose() |
