...
- [ ] **1. 替换包骨架与装配（requirements: AD-R1, AD-R3, AD-R4, AD-R11）**
...
- [ ] **2. 官方契约保真 fork（requirements: AD-R2, AD-R11）**
...
- [ ] **3. decoration registry 与链执行（requirements: AD-R5, AD-R6, AD-R7, AD-R8, AD-R9, AD-R10）**
...
- [ ] **4. 主门面 llmAdapters 条件投影与集成（requirements: AD-R5, AD-R8, AD-R10, AD-R11, AD-R12 门面侧）**
...
- [ ] **5. 验证与收尾（requirements: 全部回读；AGENTS.md §3.2/§3.4/§6）**
